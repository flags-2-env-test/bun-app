...
```bash
git clone --recurse-submodules https://github.com/flags-2-env-test/bun-app
cd bun-app
docker build -t f2e-fixture-bun .
docker run --rm f2e-fixture-bun
```
...
docker run --rm -v /tmp/mutant.toml:/app/.cli-flags.toml:ro f2e-fixture-bun
